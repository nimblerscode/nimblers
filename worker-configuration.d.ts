// Generated by Wrangler by running `wrangler types` (hash: 0bc808cb6385c1ce8c0e180ef1221144)
// Runtime types generated with workerd@1.20250409.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    ...
    ORG_DO: DurableObjectNamespace<
      import("./src/infrastructure/cloudflare/worker").OrganizationDurableObject
    >;
    SHOPIFY_OAUTH_DO: DurableObjectNamespace<
      import("./src/infrastructure/cloudflare/worker").ShopifyOAuthDurableObject
    >;
    CONVERSATION_DO: DurableObjectNamespace<
      import("./src/infrastructure/cloudflare/worker").ConversationDurableObject
    >;
    CONVERSATION_AGENT: DurableObjectNamespace<
      import("./src/infrastructure/cloudflare/worker").ConversationAgent
    >;
    DB: D1Database;
    AI: Ai;
    ASSETS: Fetcher;
