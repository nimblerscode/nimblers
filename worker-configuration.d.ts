/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f96a6aaf1e0d1f19f59b40734b1e139)
// Runtime types generated with workerd@1.20250525.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSION_SECRET: "p757FAw8BL7gRwhF_bi4F";
		ENVIRONMENT: "development";
		DEV_TUNNEL_URL: "https://fence-enlargement-submission-protective.trycloudflare.com";
		HONEYCOMB_API_KEY: "0YQfTrWYee6qkrNyHUcEBV";
		HONEYCOMB_DATASET: "nimblers";
		OTEL_EXPORTER_OTLP_ENDPOINT: "https://api.honeycomb.io/v1/traces";
		OTEL_EXPORTER_OTLP_HEADERS: "x-honeycomb-team=0YQfTrWYee6qkrNyHUcEBV";
		...
		BETTER_AUTH_SECRET_KEY: string;
		BETTER_AUTH_DATABASE_URL: string;
		BETTER_AUTH_DATABASE_PROVIDER: string;
		BETTER_AUTH_EMAIL_PASSWORD_ENABLED: string;
		...
		ORG_DO: DurableObjectNamespace<import("./src/infrastructure/cloudflare/worker").OrganizationDurableObject>;
		SHOPIFY_OAUTH_DO: DurableObjectNamespace<import("./src/infrastructure/cloudflare/worker").ShopifyOAuthDurableObject>;
		CONVERSATION_DO: DurableObjectNamespace<import("./src/infrastructure/cloudflare/worker").ConversationDurableObject>;
		CONVERSATION_AGENT: DurableObjectNamespace<import("./src/infrastructure/cloudflare/worker").ConversationAgent>;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
	}
