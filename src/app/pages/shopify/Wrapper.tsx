    ...
    <VStack gap="6">
        ...
        <Card>
          <VStack gap="4">
            ...
            {connection.errorDetails && (
              <VStack gap="2">
                <Text><strong>Details:</strong> {connection.errorDetails}</Text>
              </VStack>
            )}
            ...
            <Text>Please try connecting again or check your app configuration.</Text>
      ...
      <Card>
        <VStack gap="3">
          ...
          <Text>
            The complete OAuth flow includes:
          </Text>
          <VStack gap="1">
