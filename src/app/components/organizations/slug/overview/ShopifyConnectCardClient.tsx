              ...
              >
                <VStack gap="2" alignItems="stretch">
                  ...
                  <Text style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                    Connected:{" "}
                    {new Date(primaryStore.connectedAt).toLocaleDateString()}
                  </Text>
                  {primaryStore.lastSyncAt && (
                    <Text style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                      Last sync:{" "}
                      {new Date(primaryStore.lastSyncAt).toLocaleDateString()}
                    </Text>
                  )}
                </VStack>
              </div>
              ...
              <VStack gap="3" alignItems="stretch">
                ...
                <HStack gap="3" justifyContent="flex-end">
                  <Button
                    ...
                    isDisabled={
                      isConnecting || !shopDomain.trim() || !shopifyClientId
                    }
                    size="sm"
                    variant="primary"
                  >
                ...
                {connectedStores.map((store) => (
                  <div
                    ...
                    style={{
                      padding: "0.75rem",
                      backgroundColor:
                        store.status === "active" ? "#f0fdf4" : "#f9fafb",
                      borderRadius: "0.375rem",
                      border: "1px solid",
                      borderColor:
                        store.status === "active" ? "#bbf7d0" : "#e5e7eb",
                    }}
                  >
